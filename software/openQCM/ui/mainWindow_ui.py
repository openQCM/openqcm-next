...
class Ui_MainWindow(object):
    ...
    def setupUi(self, MainWindow):
        ...
        # VER 0.1.6G three panes here; the sidebar goes back to 280 as it was
    ...
    def _build_menubar(self, MainWindow):
        ...
        # Help. The viewers NEXT has and Q-1 does not -- the sweep-file viewer,
        # the TEC current plot, and this branch's two impedance views -- sit
        # with the viewers.
